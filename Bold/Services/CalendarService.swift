...
class CalendarService {
    ...
    private func generateEvent(from event: Event) -> EKEvent {
    ...
    private func update(event: EKEvent, with newEventData: Event) {
        event.title = newEventData.name
        event.startDate = newEventData.startDate
        event.endDate = newEventData.endDate
    }
    
    private func add(event: Event, completion: @escaping EventsCalendarManagerResponse) {
    ...
    private func update(event: EKEvent, newEventData: Event, completion: @escaping EventsCalendarManagerResponse) {
    ...
    func addEvent(_ event: Event, completion: @escaping EventsCalendarManagerResponse) {
    ...
    func updateEvent(with identifier: String, newEventData: Event, completion: @escaping EventsCalendarManagerResponse) {
        switch getAuthorizationStatus() {
        case .authorized:
