...
class ActInteractor: BaseStakesListInteractor {
...
//
//        DataSource.shared.searchEventsInAllGoals(firstRequest:true, startDate: Date().dayOfMonthOfYear(), endDate: Date().baseTime().afterOneWeek()) { (events) in
//            //print("\(events)")
//
